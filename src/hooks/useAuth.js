...
export function AuthProvider({ children }) {
    ...
    const value = useMemo(() => ({
        ...
        canReviewBookings: profile?.status === 'active' && (profile?.role === 'admin' || profile?.role === 'faculty'),
        canManageMachines: profile?.status === 'active' && (profile?.role === 'admin' || profile?.role === 'faculty'),
        canApproveFaculty: profile?.status === 'active' && profile?.role === 'admin',
        hasPermission,
